...
************************/
CREATE INDEX idx_person_id  ON cdm.person  (person_id ASC);
CLUSTER cdm.person  USING idx_person_id ;
CREATE INDEX idx_gender ON cdm.person (gender_concept_id ASC);
CREATE INDEX idx_observation_period_id_1  ON cdm.observation_period  (person_id ASC);
CLUSTER cdm.observation_period  USING idx_observation_period_id_1 ;
CREATE INDEX idx_visit_person_id_1  ON cdm.visit_occurrence  (person_id ASC);
CLUSTER cdm.visit_occurrence  USING idx_visit_person_id_1 ;
CREATE INDEX idx_visit_concept_id_1 ON cdm.visit_occurrence (visit_concept_id ASC);
CREATE INDEX idx_visit_det_person_id_1  ON cdm.visit_detail  (person_id ASC);
CLUSTER cdm.visit_detail  USING idx_visit_det_person_id_1 ;
...
CREATE INDEX idx_condition_person_id_1  ON cdm.condition_occurrence  (person_id ASC);
CLUSTER cdm.condition_occurrence  USING idx_condition_person_id_1 ;
...
CREATE INDEX idx_drug_person_id_1  ON cdm.drug_exposure  (person_id ASC);
CLUSTER cdm.drug_exposure  USING idx_drug_person_id_1 ;
...
CREATE INDEX idx_procedure_person_id_1  ON cdm.procedure_occurrence  (person_id ASC);
CLUSTER cdm.procedure_occurrence  USING idx_procedure_person_id_1 ;
...
CREATE INDEX idx_device_person_id_1  ON cdm.device_exposure  (person_id ASC);
CLUSTER cdm.device_exposure  USING idx_device_person_id_1 ;
...
CREATE INDEX idx_measurement_person_id_1  ON cdm.measurement  (person_id ASC);
CLUSTER cdm.measurement  USING idx_measurement_person_id_1 ;
...
CREATE INDEX idx_observation_person_id_1  ON cdm.observation  (person_id ASC);
CLUSTER cdm.observation  USING idx_observation_person_id_1 ;
...
CREATE INDEX idx_death_person_id_1  ON cdm.death  (person_id ASC);
CLUSTER cdm.death  USING idx_death_person_id_1 ;
CREATE INDEX idx_note_person_id_1  ON cdm.note  (person_id ASC);
CLUSTER cdm.note  USING idx_note_person_id_1 ;
...
CREATE INDEX idx_note_nlp_note_id_1  ON cdm.note_nlp  (note_id ASC);
CLUSTER cdm.note_nlp  USING idx_note_nlp_note_id_1 ;
CREATE INDEX idx_note_nlp_concept_id_1 ON cdm.note_nlp (note_nlp_concept_id ASC);
CREATE INDEX idx_specimen_person_id_1  ON cdm.specimen  (person_id ASC);
CLUSTER cdm.specimen  USING idx_specimen_person_id_1 ;
...
************************/
CREATE INDEX idx_location_id_1  ON cdm.location  (location_id ASC);
CLUSTER cdm.location  USING idx_location_id_1 ;
CREATE INDEX idx_care_site_id_1  ON cdm.care_site  (care_site_id ASC);
CLUSTER cdm.care_site  USING idx_care_site_id_1 ;
CREATE INDEX idx_provider_id_1  ON cdm.provider  (provider_id ASC);
CLUSTER cdm.provider  USING idx_provider_id_1 ;
/************************
Standardized health economics
************************/
CREATE INDEX idx_period_person_id_1  ON cdm.payer_plan_period  (person_id ASC);
CLUSTER cdm.payer_plan_period  USING idx_period_person_id_1 ;
CREATE INDEX idx_cost_event_id  ON cdm.cost (cost_event_id ASC);
/************************
Standardized derived elements
************************/
CREATE INDEX idx_drug_era_person_id_1  ON cdm.drug_era  (person_id ASC);
CLUSTER cdm.drug_era  USING idx_drug_era_person_id_1 ;
CREATE INDEX idx_drug_era_concept_id_1 ON cdm.drug_era (drug_concept_id ASC);
CREATE INDEX idx_dose_era_person_id_1  ON cdm.dose_era  (person_id ASC);
CLUSTER cdm.dose_era  USING idx_dose_era_person_id_1 ;
CREATE INDEX idx_dose_era_concept_id_1 ON cdm.dose_era (drug_concept_id ASC);
CREATE INDEX idx_condition_era_person_id_1  ON cdm.condition_era  (person_id ASC);
CLUSTER cdm.condition_era  USING idx_condition_era_person_id_1 ;
CREATE INDEX idx_condition_era_concept_id_1 ON cdm.condition_era (condition_concept_id ASC);
/**************************
Standardized meta-data
***************************/
CREATE INDEX idx_metadata_concept_id_1  ON cdm.metadata  (metadata_concept_id ASC);
CLUSTER cdm.metadata  USING idx_metadata_concept_id_1 ;
/**************************
Standardized vocabularies
***************************/
CREATE INDEX idx_concept_concept_id  ON cdm.concept  (concept_id ASC);
...
CREATE INDEX idx_vocabulary_vocabulary_id  ON cdm.vocabulary  (vocabulary_id ASC);
CLUSTER cdm.vocabulary  USING idx_vocabulary_vocabulary_id ;
CREATE INDEX idx_domain_domain_id  ON cdm.domain  (domain_id ASC);
CLUSTER cdm.domain  USING idx_domain_domain_id ;
CREATE INDEX idx_concept_class_class_id  ON cdm.concept_class  (concept_class_id ASC);
...
CLUSTER cdm.concept_relationship  USING idx_concept_relationship_id_1 ;
...
CREATE INDEX idx_relationship_rel_id  ON cdm.relationship  (relationship_id ASC);
...
CREATE INDEX idx_source_to_concept_map_3  ON cdm.source_to_concept_map  (target_concept_id ASC);
CLUSTER cdm.source_to_concept_map  USING idx_source_to_concept_map_3 ;
